...
public:
    ...
    /*	while (true) {
    	    		...
    	    		genesis = CreateGenesisBlock(1532004360,2310185, 0x1e0ffff0, 1, 20 * COIN);
    	    	        ...
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1536056513;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1536056514;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1536056513;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1536056514;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1536056513;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 1536056514;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].bit = 2;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 1536056513;
    	    	        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout =1536056514 ;
